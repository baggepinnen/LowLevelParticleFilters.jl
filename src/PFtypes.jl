...
@with_kw struct AdvancedParticleFilter{ST,FT,GT,FDT,IDT,RST<:DataType,RNGT} <: AbstractParticleFilter
    state::ST
    dynamics::FT
    measurement::GT
...
sample_measurement(pf::AdvancedParticleFilter, x, t) = measurement(pf)(x, t)
